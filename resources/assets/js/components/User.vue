            ...
            <span aria-hidden="true">×</span>
				...
				<div class="modal-body">
                  ...
                  <option v-for="rol in arrayRol" :key="rol.id" :value="rol.id" v-text="rol.nombre"></option>
						...
						<div v-show="errorPersona" class="form-group row">
  ...
  computed: {
	...
	methods: {
		listarPersona(page, buscar, criterio) {
			let self = this;
			let url = '/user?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
			axios.get(url).then(function(response) {
					let respuesta = response.data;
					self.arrayPersona = respuesta.personas.data;
		...
		cambiarPagina(page, buscar, criterio) {
			...
			self.listarPersona(page, buscar, criterio);
		},
		registrarPersona() {
		...
		validarPersona() {
			...
			if (!this.nombre) this.errorsMsgs.push("El nombre de la persona no puede estar vacío.");
			if (!this.usuario) this.errorsMsgs.push("El nombre de usuario no puede estar vacío.");
			if (!this.password) this.errorsMsgs.push("El password no puede estar vacío.");
			if (this.idrol == 0) this.errorsMsgs.push("Debes seleccionar un rol para el usuario.");

			if (this.errorsMsgs.length) this.errorPersona = 1;
